...
export const POKEMON_MOVE_INFORMATION_EXTERNAL_RESPONSE_SWORDS_DANCE_FIXTURE: PokemonMoveInformationExternalResponse = {
    move: {
        name: 'swords-dance',
...
export const POKEMON_MOVE_INFORMATION_EXTERNAL_RESPONSE_CUT_FIXTURE: PokemonMoveInformationExternalResponse = {
    move: {
        name: 'cut',
...
export const POKEMON_MOVE_INFORMATION_EXTERNAL_RESPONSE_LIST_FIXTURE: PokemonMovesInformationExternalResponse = [
...
export const EXTERNAL_RESPONSE_OF_MOVE_BY_URL_RAZOR_WIND_FIXTURE: ExternalResponseOfMoveByUrl = {
    pp: 10,
    type: {
        url: 'https://pokeapi.co/api/v2/type/1/',
        name: 'normal',
    },
    name: POKEMON_MOVE_INFORMATION_EXTERNAL_RESPONSE_RAZOR_WIND_FIXTURE.move.name,
    power: 80,
    target: {
...
export const EXTERNAL_RESPONSE_OF_MOVE_BY_URL_SWORDS_DANCE_FIXTURE: ExternalResponseOfMoveByUrl = {
    pp: 20,
    type: {
        url: 'https://pokeapi.co/api/v2/type/1/',
        name: 'normal',
    },
    name: POKEMON_MOVE_INFORMATION_EXTERNAL_RESPONSE_SWORDS_DANCE_FIXTURE.move.name,
    power: undefined,
    target: {
...
export const EXTERNAL_RESPONSE_OF_MOVE_BY_URL_CUT_FIXTURE: ExternalResponseOfMoveByUrl = {
    pp: 30,
    type: {
        url: 'https://pokeapi.co/api/v2/type/1/',
        name: 'normal',
    },
    name: POKEMON_MOVE_INFORMATION_EXTERNAL_RESPONSE_CUT_FIXTURE.move.name,
    power: 50,
    target: {
...
export const EXTERNAL_RESPONSE_OF_MOVE_BY_URL_LIST_FIXTURE: Array<ExternalResponseOfMoveByUrl> = [
