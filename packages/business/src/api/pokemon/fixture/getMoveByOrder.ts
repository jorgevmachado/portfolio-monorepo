import { IResponsePokemonMove } from '../interface';

export const RESPONSE_GET_MOVE_BY_ORDER_RAZOR_WIND_FIXTURE: IResponsePokemonMove =
  {
    pp: 10,
    type: {
...
export const RESPONSE_GET_MOVE_BY_ORDER_SWORDS_DACE_FIXTURE: IResponsePokemonMove =
  {
    pp: 20,
    type: {
      url: 'https://pokeapi.co/api/v2/type/1/',
...
export const RESPONSE_GET_MOVE_BY_ORDER_CUT_FIXTURE: IResponsePokemonMove = {
  pp: 30,
  type: {
    url: 'https://pokeapi.co/api/v2/type/1/',
    name: 'normal',
