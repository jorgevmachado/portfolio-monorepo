...
import { IResponsePokemon, IResponsePokemonEvolution, IResponsePokemonName, IResponsePokemonSpecie, IResponsePokemonMove } from "./interface";
...
export class PokemonApi extends Http {
  ...
  async getAll(offset: number, limit: number): Promise<ResponsePaginate<IResponsePokemon>> {
  ...
  async getEvolutionsByOrder(order: number): Promise<IResponsePokemonEvolution> {
