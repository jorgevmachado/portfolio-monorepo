...
export const POKEMON_STATS_ATTRIBUTES_BULBASAUR_FIXTURE: PokemonStatsAttributes =
  {
    ...
    defense: POKEMON_STAT_INFORMATION_EXTERNAL_RESPONSE_DEFENSE_FIXTURE.base_stat,
    special_attack: POKEMON_STAT_INFORMATION_EXTERNAL_RESPONSE_SPECIAL_ATTACK_FIXTURE.base_stat,
    special_defense: POKEMON_STAT_INFORMATION_EXTERNAL_RESPONSE_SPECIAL_DEFENSE_FIXTURE.base_stat,
  };