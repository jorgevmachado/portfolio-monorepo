...
export const ENTITY_ABILITY_OVERGROW_FIXTURE: EntityAbility = {
...
export const ENTITY_ABILITY_CHLOROPHYLL_FIXTURE: EntityAbility = {
...
export const ENTITY_ABILITY_LIST_FIXTURE: Array<EntityAbility> = [
