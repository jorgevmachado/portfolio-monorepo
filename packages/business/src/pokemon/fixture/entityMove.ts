...
export const ENTITY_MOVE_RAZOR_WIND_FIXTURE: EntityMove = {
  ...
  url: RESPONSE_MOVE_RAZOR_WIND_FIXTURE.move.url,
  type: RESPONSE_POKEMON_MOVE_RAZOR_WIND_FIXTURE.type,
  name: RESPONSE_MOVE_RAZOR_WIND_FIXTURE.move.name,
  order: RESPONSE_MOVE_RAZOR_WIND_FIXTURE.order,
...
export const ENTITY_MOVE_SWORDS_DANCE_FIXTURE: EntityMove = {
  ...
  url: RESPONSE_MOVE_SWORDS_DANCE_FIXTURE.move.url,
  type: RESPONSE_POKEMON_MOVE_SWORDS_DANCE_FIXTURE.type,
  name: RESPONSE_MOVE_SWORDS_DANCE_FIXTURE.move.name,
  order: RESPONSE_MOVE_SWORDS_DANCE_FIXTURE.order,
  ...
  learned_by_pokemon: JSON.stringify(RESPONSE_POKEMON_MOVE_SWORDS_DANCE_FIXTURE.learned_by_pokemon),
};

export const ENTITY_MOVE_CUT_FIXTURE: EntityMove = {
  id: '620458fb-26de-49af-b2ca-1428916c627d',
  pp: 30,
  url: RESPONSE_MOVE_CUT_FIXTURE.move.url,
  type: RESPONSE_POKEMON_MOVE_CUT_FIXTURE.type,
  name: RESPONSE_MOVE_CUT_FIXTURE.move.name,
  order: RESPONSE_MOVE_CUT_FIXTURE.order,
  ...
  learned_by_pokemon: JSON.stringify(RESPONSE_POKEMON_MOVE_CUT_FIXTURE.learned_by_pokemon),
};
